...
<div class="">
        ...
        <a href="{{ route('biodata-export') }}" class="text-primary btn btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cloud-download" viewBox="0 0 16 16">
...
<table class="table table-hover">
  ...
  @foreach ($biodatas as $biodata)
    ...
    <tr>
      ...
      <td>
        <form action="/admin/biodata/{{$biodata->nim}}" method="post">
          @method('delete')
          @csrf
          @if ($biodata->name != "admin")
